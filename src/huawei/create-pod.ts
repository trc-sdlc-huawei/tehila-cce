...
export async function HuaweiCreatePod(
  ...
  logInfo(`HuaweiCreatePod called with region=${region}, cluster_id=${cluster_id}, namespace=${namespace}, pod_name=${pod_name}, container_name=${container_name}, image=${image}`);
